        ...
        while (el--) {
          switch (dir) {
            ...
            case 1:
              ...
              break;
            case 2:
              tmpy = (y - 1 + maxLength) % maxLength;
              while (map[x][tmpy] === " ") {
                tmpy = (tmpy - 1 + maxLength) % maxLength;
              }
              if (map[x][tmpy] === "#") {
                el = 0;
              } else {
              ...
              break;
            case 3:
              tmpx = (x - 1 + map.length) % map.length;
              while (map[tmpx][y] === " ") {
                tmpx = (tmpx - 1 + map.length) % map.length;
              }
              if (map[tmpx][y] === "#") {
                el = 0;
              } else {
