(() => {
  function solve(input) {
    ...
    for (var i = 0; i < lines.length; i++) {
      ...
      var sue = parseInt(line[1].slice(0, -1));
      line.shift();
      line.shift();
      line = line.join("");
      line = line.split(",");
      ...
      for (var j = 0; j < line.length && found; j++) {
        var l = line[j].split(":");
        if (l[0] == "cats" || l[0] == "trees")
          found = mfcsam[l[0]] < parseInt(l[1]);
        else if (l[0] == "pomeranians" || l[0] == "goldfish")
          found = mfcsam[l[0]] > parseInt(l[1]);
        else found = mfcsam[l[0]] == parseInt(l[1]);
      }
