(() => {
  function solve(input) {
    ...
    for (var line of lines) {
      ...
      var posx = pos(p[0], v[0], a[0], iteration);
      var posy = pos(p[1], v[1], a[1], iteration);
      var posz = pos(p[2], v[2], a[2], iteration);
      var distance = Math.abs(posx) + Math.abs(posy) + Math.abs(posz);
      if (distance < min) {
        min = distance;
        iMin = i;
      }
